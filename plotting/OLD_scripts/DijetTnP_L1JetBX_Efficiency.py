...
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy_JetHT2017F_UnprefireableFilterON_SingleJetTriggers/uhh2.AnalysisModuleRunner.DATA.Run2017F.root', 'open')

#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy_JetHT2017F_UnprefireableFilterON_SingleJetTriggers_addFwd/uhh2.AnalysisModuleRunner.DATA.Run2017F.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy_JetHT2017F_UnprefireableFilterON_SingleJetTriggers_addFwd/uhh2.AnalysisModuleRunner.DATA.Run2017E.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy_JetHT2017F_UnprefireableFilterON_SingleJetTriggers_addFwd/uhh2.AnalysisModuleRunner.DATA.Run2017D.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy_JetHT2017F_UnprefireableFilterON_SingleJetTriggers_addFwd/uhh2.AnalysisModuleRunner.DATA.Run2017C.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy_JetHT2017F_UnprefireableFilterON_SingleJetTriggers_addFwd/uhh2.AnalysisModuleRunner.DATA.Run2017B.root', 'open')
...
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2016_UnprefireableFilterON_DijetTriggers_addL1JetEtaPhi_patJetsAK4PFCHS_addMultMatch_L1L2L3/uhh2.AnalysisModuleRunner.DATA.Run2016B.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2016_UnprefireableFilterON_DijetTriggers_addL1JetEtaPhi_patJetsAK4PFCHS_addMultMatch_L1L2L3/uhh2.AnalysisModuleRunner.DATA.Run2016C.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2016_UnprefireableFilterON_DijetTriggers_addL1JetEtaPhi_patJetsAK4PFCHS_addMultMatch_L1L2L3/uhh2.AnalysisModuleRunner.DATA.Run2016D.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2016_UnprefireableFilterON_DijetTriggers_addL1JetEtaPhi_patJetsAK4PFCHS_addMultMatch_L1L2L3/uhh2.AnalysisModuleRunner.DATA.Run2016E.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2016_UnprefireableFilterON_DijetTriggers_addL1JetEtaPhi_patJetsAK4PFCHS_addMultMatch_L1L2L3/uhh2.AnalysisModuleRunner.DATA.Run2016F.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2016_UnprefireableFilterON_DijetTriggers_addL1JetEtaPhi_patJetsAK4PFCHS_addMultMatch_L1L2L3/uhh2.AnalysisModuleRunner.DATA.Run2016G.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2016_UnprefireableFilterON_DijetTriggers_addL1JetEtaPhi_patJetsAK4PFCHS_addMultMatch_L1L2L3/uhh2.AnalysisModuleRunner.DATA.Run2016H.root', 'open')

#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2017_UnprefireableFilterON_SingleJetTriggers_addFwd_patJetsAK4PFCHS_addMultMatch/uhh2.AnalysisModuleRunner.DATA.Run2017B.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2017_UnprefireableFilterON_SingleJetTriggers_addFwd_patJetsAK4PFCHS_addMultMatch/uhh2.AnalysisModuleRunner.DATA.Run2017C.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2017_UnprefireableFilterON_SingleJetTriggers_addFwd_patJetsAK4PFCHS_addMultMatch/uhh2.AnalysisModuleRunner.DATA.Run2017D.root', 'open')
#fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2017_UnprefireableFilterON_SingleJetTriggers_addFwd_patJetsAK4PFCHS_addMultMatch/uhh2.AnalysisModuleRunner.DATA.Run2017E.root', 'open')
fin = TFile('/nfs/dust/cms/user/karavdia/PreFireStudy/JetHT2017_UnprefireableFilterON_SingleJetTriggers_addFwd_patJetsAK4PFCHS_addMultMatch/uhh2.AnalysisModuleRunner.DATA.Run2017F.root', 'open')
...
#regions={'':''} #BB: 0<eta<1.3, EC1: 1.3<eta<2.5, EC2: 2.5<eta<3.0, HF: 3.0<eta<5.2, all combined
...
#            hists[key_dir_+dist_+key_region].Rebin(4)
        ...
        hists['L1Jet in BX -1'+dist_+key_region].GetYaxis().SetRangeUser(0.0,1.4) #L1Jet
#        hists['L1Jet in BX -1'+dist_+key_region].GetYaxis().SetRangeUser(0.0,1000) #L1Jet
...
#        canvas_dist[dist_+key_region].SaveAs('Eff_'+dist_+regions[key_region]+'.root')
