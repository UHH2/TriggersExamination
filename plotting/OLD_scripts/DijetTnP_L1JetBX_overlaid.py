...
distrs=['L1J_drJetProbeMin_mpfResponse','L1J_drJetProbeMin_pBalResponse','L1J_drJetProbeMin_pBalAsymmetry','L1J_drJetProbeMin_mpfAsymmetry',
        'L1J_drJetProbeMin_dR', 'L1J_drJetProbeMin_Pt','L1J_drJetProbeMin_Ptave',
...
for dist_ in distrs:
    for key_region in regions:
        ...
        for key_dir_ in dirs:
            ...
            print hists[key_dir_+dist_+key_region]
...
#        canvas_dist[dist_+key_region].SaveAs(dist_+regions[key_region]+'.root')
